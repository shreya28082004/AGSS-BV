  ...
  return (
    <div className="min-h-screen font-sans bg-gradient-to-br from-[#f9ede3] via-[#f5e3d1] to-[#e7c9a9] flex flex-col">
      ...
      >
        ...
        <Link className="block py-2 px-3 rounded hover:bg-cream-200 hover:text-brown-900 transition" to="/">
          Home
        </Link>
        <Link className="block py-2 px-3 rounded hover:bg-cream-200 hover:text-brown-900 transition" to="/about">
          About
        </Link>
